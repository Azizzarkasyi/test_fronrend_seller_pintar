...
const mockArticle = {
  ...
  content:
    "Next.js 15 brings exciting new features and improvements that make building React applications even more powerful and efficient. In this comprehensive guide, we'll explore the key features and show you how to get started.\n\nThe new App Router provides a more intuitive way to structure your applications, with improved performance and developer experience. Server Components allow you to render components on the server, reducing the amount of JavaScript sent to the client.\n\nWith enhanced TypeScript support and better debugging tools, Next.js 15 is a significant step forward for React developers.",
  excerpt:
    "Discover the powerful new features in Next.js 15 and learn how to leverage them in your React applications for better performance and developer experience.",
  ...
  useEffect(() => {
    const loadArticle = async () => {
      try {
        ...
        // Set form values
        setValue("title", mockArticle.title);
        setValue("content", mockArticle.content);
        setValue("excerpt", mockArticle.excerpt);
        setValue("category", mockArticle.category);
        setValue("image", mockArticle.image);
        setValue("tags", mockArticle.tags);
      } catch (err) {
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 file:mr-4 file:py-2 file:px-4 file:rounded-l-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                      />
                      {selectedFile && (
                    ...
                    {(uploadedImageUrl || watch("image")) && (
                      <div className="mt-3">
                        <p className="text-sm font-medium text-gray-700 mb-2">
                          Preview:
                        </p>
                        <img
                          src={uploadedImageUrl || watch("image")}
                          alt="Preview"
                  ...
                  <input
                    type="hidden"
                    {...register("image")}
                    value={uploadedImageUrl || watch("image") || ""}
                  />
